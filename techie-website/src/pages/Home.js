        ...
        <div className="row">
          <div className="col-6">
            <div className="main-banner position-relative ">
              <img
                src="https://www.laptopstoreindia.in/wp-content/uploads/2022/01/ld-spares-bg.jpg"
                className="rounded-3"
                alt="main banner"
                height="418px"
                width="645px"
          ...
          <div className="col-6">
            <div className="d-flex flex-wrap gap-10 justify-content-between align-items-center">
              ...
              <div className="small-banner position-relative">
                <img
                  src="https://cdn.britannica.com/64/170564-050-7A0A86A2/motherboard-for-computer.jpg"
                  className="rounded-3"
                  alt="main banner"
                  height="205px"
                  width="310px"
